...
from r6pugs import (TurnBasedVetoMenu, TurnBasedSelectionMenu, PollMenu,
                    ConfirmationMenu, SingleSelectionMenu)
...
class PugTests:
    ...
    @commands.command()
    @commands.guild_only()
    async def testpoll(self,
                       ctx: commands.Context,
                       n_options: int=10,
                       *others: discord.Member):
